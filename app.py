...
<style>
:root{--primary:#10069F;--primary-dark:#02003d;--white:#fff;--ink:#111827;--muted:#6b7280;--surface:#f5f5f7;--silver:#e5e7eb;--success:#24824f;--danger:#b52936;--warning:#d99800;font-family:Inter,Segoe UI,Arial,sans-serif;color:var(--ink);background:var(--surface);font-synthesis:none;text-rendering:optimizeLegibility;-webkit-font-smoothing:antialiased}
*{box-sizing:border-box}body{margin:0;min-width:320px;background:var(--surface)}button,input,select,textarea{font:inherit}button:not(:disabled),a,select,summary{cursor:pointer}button:disabled{cursor:not-allowed}a{color:inherit;text-decoration:none}h1,h2,h3,p{margin-top:0}.display{font-family:Georgia,'Times New Roman',serif}.hidden{display:none!important}.app{min-height:100vh}.login-page{min-height:100vh;display:flex;align-items:center;justify-content:center;padding:48px 24px}.login-card{width:100%;max-width:448px;border:1px solid var(--silver);background:#fff;box-shadow:0 4px 18px rgba(20,32,48,.08)}.login-body{padding:32px}.eyebrow{color:var(--primary);font-size:11px;font-weight:700;letter-spacing:.18em;text-transform:none}.login-body h2{color:var(--primary);font-size:24px;margin:8px 0 0}.muted{color:var(--muted)}.small{font-size:13px}.tiny{font-size:11px}.primary-button,.secondary-button,.success-button,.danger-button,.warning-button{min-height:40px;border-radius:4px;padding:10px 16px;font-size:14px;font-weight:650;border:1px solid transparent}.primary-button{background:var(--primary);color:#fff}.primary-button:hover{background:var(--primary-dark)}.secondary-button{background:#fff;border-color:var(--primary);color:var(--primary)}.success-button{background:#1f7a45;color:#fff}.danger-button{background:#dc3545;color:#fff}.warning-button{background:#ffc107;color:#111}.wide{width:100%}.user-list{display:grid;gap:8px;margin-top:14px}.user-choice{display:flex;width:100%;align-items:center;justify-content:space-between;border:1px solid var(--silver);background:#fff;padding:12px 16px;text-align:left}.user-choice:hover{background:var(--surface)}.user-choice strong,.user-choice span{display:block}.shell{display:flex;min-height:100vh}.sidebar{width:256px;flex:0 0 256px;background:var(--primary);color:#fff;display:flex;flex-direction:column}.sidebar-heading{height:80px;display:flex;align-items:center;padding:0 24px;border-bottom:1px solid #28436c;font-weight:700;font-size:14px}.sidebar-nav{padding:26px 0;flex:1}.nav-label{padding:10px 20px 7px;color:#8ea5c7;font-size:10px;font-weight:700;letter-spacing:.22em;text-transform:none}.nav-link{display:flex;align-items:center;border-left:2px solid transparent;padding:10px 20px;color:#d9e0eb;font-size:14px;transition:.15s}.nav-link:hover{background:var(--primary-dark);color:#fff}.nav-link.active{border-left-color:#fff;background:#e9eef6;color:var(--primary);font-weight:650}.workspace{display:flex;min-width:0;flex:1;flex-direction:column}.topbar{height:80px;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid var(--silver);background:#fff;padding:0 32px;position:relative}.search{width:320px;border:1px solid var(--silver);padding:10px 12px;font-size:13px}.top-actions{display:flex;align-items:center;gap:20px}.text-button{border:1px solid var(--primary);border-radius:4px;background:#fff;color:var(--primary);font-size:14px;font-weight:650;padding:9px 13px}.text-button:hover{background:#f4f3ff}.content{padding:36px 32px 56px;min-width:0}.page{max-width:1440px;margin:0 auto}.page-header{display:flex;align-items:flex-end;justify-content:space-between;gap:16px;margin-bottom:24px}.page-header h1{color:var(--primary);font-size:38px;margin:8px 0 0}.page-header p:last-child{margin:8px 0 0}.status-chip{display:inline-block;white-space:nowrap;border-radius:999px;background:#e9eef6;padding:5px 9px;color:var(--primary);font-size:11px;font-weight:700;text-transform:none}.status-live{background:#e5f5ed;color:#176b45}.status-banner{display:flex;align-items:center;justify-content:space-between;gap:16px;border:1px solid #e6d29a;background:#fff9e8;padding:12px 16px;color:#705b18;font-size:13px;margin-bottom:24px}.summary-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:16px;margin-bottom:24px}.summary-card,.panel,.info-card{border:1px solid var(--silver);background:#fff}.summary-card{padding:16px}.summary-card p{min-height:34px;color:var(--muted);font-size:11px;font-weight:700;line-height:1.25;text-transform:none;margin:0}.summary-card strong{display:block;margin-top:8px;color:var(--primary);font-family:Georgia,serif;font-size:32px}.panel,.info-card{padding:20px;margin-bottom:24px;overflow:hidden}.panel-heading{display:flex;align-items:center;justify-content:space-between;gap:16px;border-bottom:1px solid var(--silver);padding-bottom:16px}.panel-heading h2,.info-card h2{color:var(--primary);font-family:Georgia,serif;font-size:20px;margin:4px 0 0}.split{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:24px}.metric-number{font-size:32px;color:var(--primary);font-weight:700;margin:16px 0 6px}.table-wrap{overflow-x:auto}.data-table{width:100%;border-collapse:collapse;text-align:left;font-size:13px}.data-table th{border-bottom:1px solid var(--silver);padding:13px;color:var(--muted);font-size:10px;text-transform:none;letter-spacing:.05em}.data-table td{border-bottom:1px solid var(--silver);padding:13px;color:var(--muted);vertical-align:top}.data-table td.strong{color:var(--ink);font-weight:650}.data-table tr:last-child td{border-bottom:0}.data-table tbody tr:hover{background:#fafafa}.link{color:var(--primary);font-weight:650}.empty{padding:24px 0;color:var(--muted);font-size:14px}.error-box{display:flex;align-items:center;justify-content:space-between;gap:16px;border:1px solid #e1b5b5;background:#fff4f4;color:#9b2c2c;padding:16px;font-size:14px;margin-bottom:20px}.form-page{max-width:896px;margin:0 auto}.form-section{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px;border:1px solid var(--silver);background:#fff;padding:24px;margin-bottom:24px}.form-section.single{display:block}.field{display:block;font-size:13px;font-weight:650;color:var(--ink)}.field input,.field select,.field textarea{display:block;width:100%;margin-top:8px;border:1px solid var(--silver);background:#fff;padding:10px 12px;font-weight:400;color:var(--ink);outline:none}.field input:focus,.field select:focus,.field textarea:focus{border-color:var(--primary);box-shadow:0 0 0 2px rgba(4,1,90,.08)}.field-error{display:block;color:#9b2c2c;font-size:11px;font-weight:400;margin-top:5px}.check-row{display:flex;align-items:center;gap:12px;border:1px solid var(--silver);background:#fff;padding:16px;margin-bottom:12px;font-size:14px;font-weight:650}.date-row,.asset-row{display:grid;grid-template-columns:1fr 1fr 1fr auto;gap:12px;border:1px solid var(--silver);padding:12px;margin-top:12px;align-items:end}.button-row{display:flex;flex-wrap:wrap;gap:12px;align-items:center}.review-box{border:1px solid var(--primary);background:#f4f7fb;padding:20px;margin-bottom:24px}.review-box h2{color:var(--primary);font-family:Georgia,serif;margin:0}.classification-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:12px;margin:16px 0}.classification{display:flex;align-items:center;gap:12px;border:1px solid var(--silver);background:#fff;padding:12px;font-size:13px;font-weight:650}.swatch{width:12px;height:12px;border-radius:50%}.reception-actions{display:flex;flex-wrap:wrap;align-items:center;gap:12px;border:1px solid var(--primary);background:#e9eef6;padding:20px;margin-bottom:24px}.day-picker{border:1px solid var(--silver);background:#fff;padding:9px 10px}.info-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:24px}.info-card{margin:0}.info-card p{font-size:13px;margin:0 0 9px}.info-card p:last-child{margin-bottom:0}.info-card .record{border-bottom:1px solid var(--silver);padding-bottom:10px;margin-bottom:10px}.info-card .record:last-child{border-bottom:0;margin-bottom:0}.detail-stack{display:grid;gap:24px}.back-link{display:inline-block;margin-bottom:24px}.modal-backdrop{position:fixed;inset:0;z-index:80;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.5);padding:16px}.modal{width:100%;max-width:520px;border:1px solid var(--silver);background:#fff;padding:24px;box-shadow:0 20px 60px rgba(0,0,0,.25)}.modal h2{font-family:Georgia,serif;color:var(--primary);margin:0}.modal-actions{display:flex;justify-content:flex-end;gap:12px;margin-top:24px}.mobile-menu{display:none}.mobile-records{display:none}.toast{position:fixed;right:24px;bottom:24px;z-index:100;background:#111827;color:#fff;padding:13px 16px;box-shadow:0 8px 28px rgba(0,0,0,.25);font-size:13px;max-width:360px}.toast.error{background:#9b2c2c}.loading{color:var(--muted);font-size:14px}
.required-mark{color:#b52936;font-weight:800}.required-note{margin:-10px 0 14px;color:var(--muted);font-size:12px;text-align:right}.section-span{grid-column:1/-1;border-bottom:1px solid var(--silver);padding-bottom:14px;margin-bottom:2px}.section-span h2{margin:5px 0 0;color:var(--primary);font-size:21px}.schedule-card{border:1px solid var(--silver);background:#fff;padding:24px;margin-bottom:24px}.schedule-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:20px;border-bottom:1px solid var(--silver);padding-bottom:18px}.schedule-heading h2{margin:5px 0 6px;color:var(--primary);font-size:24px}.timezone-pill{white-space:nowrap;border-radius:999px;background:#e9eef6;color:var(--primary);padding:7px 11px;font-size:11px;font-weight:700}.schedule-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px;margin-top:20px}.requested-field{border-left:4px solid var(--warning);background:#fff8e1;padding:10px}.phone-fields{display:grid;grid-template-columns:minmax(210px,1fr) minmax(180px,1fr);gap:12px}.phone-input{position:relative}.phone-prefix{position:absolute;left:12px;bottom:11px;color:var(--muted);font-size:13px}.phone-input input{padding-left:58px}.field-note{display:block;margin-top:5px;color:var(--muted);font-size:11px;font-weight:400}.checkbox-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin-top:12px}.checkbox-grid .check-row{margin:0}.summary-link{display:block;position:relative}.summary-link:after{content:'View →';display:block;margin-top:10px;color:var(--primary);font-size:11px;font-weight:700}.summary-link:hover{border-color:var(--primary);box-shadow:0 4px 14px rgba(4,1,90,.08)}.verification-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px;margin:18px 0}.verification-step{border:1px solid #cfd5df;border-radius:8px;background:#fff;padding:16px}.verification-step h3{font-size:14px;margin:0}.verification-step .button-row{margin-top:14px}.badge-panel{display:grid;grid-template-columns:minmax(180px,1fr) minmax(220px,2fr);gap:14px;align-items:end;border:1px solid #cfd5df;border-radius:8px;background:#fff;padding:16px;margin-bottom:14px}.badge-type{display:inline-block;border-radius:999px;padding:7px 11px;color:#fff;font-size:12px;font-weight:750}.badge-orange{background:#a64b00}.badge-red{background:#c62828}.completion-checks{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.completion-check{display:flex;align-items:center;gap:10px;border:1px solid var(--primary);border-radius:8px;background:#fff;padding:14px;font-weight:700}.completion-check input{width:19px;height:19px}
:focus-visible{outline:3px solid #786df2;outline-offset:3px}.skip-link{position:fixed;left:16px;top:-60px;z-index:120;border-radius:6px;background:#fff;color:var(--primary);padding:10px 14px;font-weight:700;box-shadow:0 4px 16px rgba(0,0,0,.2)}.skip-link:focus{top:16px}.primary-button,.secondary-button,.success-button,.danger-button,.warning-button,.text-button,.user-choice,.reception-person{transition:background-color .15s,border-color .15s,box-shadow .15s,transform .15s}.primary-button:active,.secondary-button:active,.success-button:active,.danger-button:active,.warning-button:active,.text-button:active,.user-choice:active,.reception-person:active{transform:translateY(1px)}.summary-card,.panel,.info-card,.form-section,.schedule-card,.review-box,.reception-actions,.login-card{border-radius:10px}.field input,.field select,.field textarea,.search{border-radius:7px;min-height:42px}.compact-button{display:inline-block;min-height:34px;padding:7px 10px}.form-record{display:flex;justify-content:space-between;align-items:center;gap:12px}.selection-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;margin:18px 0}.selection-card{display:grid;grid-template-columns:auto minmax(0,1fr) auto auto;align-items:center;gap:10px;border:1px solid #cfd5df;border-radius:8px;background:#fff;padding:12px;cursor:pointer}.selection-card:has(input:checked){border-color:var(--primary);box-shadow:0 0 0 2px rgba(4,1,90,.1)}.selection-card small{display:block;color:var(--muted);margin-top:3px}.tag{display:inline-block;border-radius:999px;padding:5px 9px;color:#fff;font-size:11px;font-weight:750}.tag-vendor{background:#a64b00}.tag-visitor{background:#c62828}.reception-actions{display:block}.reception-queue{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;margin-bottom:18px}.reception-person{display:flex;align-items:center;justify-content:space-between;gap:12px;border:1px solid #cfd5df;border-radius:8px;background:#fff;padding:12px;text-align:left}.reception-person small{display:block;color:var(--muted);margin-top:4px}.reception-person.active{border-color:var(--primary);box-shadow:0 0 0 2px rgba(4,1,90,.12);background:#f7f6ff}.reception-controls{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;margin-bottom:14px}.modal{max-height:min(720px,calc(100vh - 32px));overflow-y:auto;border-radius:12px}.toast{border-radius:8px}.mobile-reception{display:none}
.content{padding:24px 24px 40px}.page{max-width:1280px}.page-header{margin-bottom:18px}.page-header h1{font-size:32px}.summary-grid{gap:10px;margin-bottom:16px}.summary-card{padding:13px}.summary-card p{min-height:auto}.summary-card strong{font-size:27px}.panel,.info-card{padding:16px;margin-bottom:16px}.form-section,.schedule-card{padding:18px;margin-bottom:16px}.privacy-notice{border:1px solid #b8c5d8;border-radius:8px;background:#f4f7fb;color:#43516a;padding:10px 12px;font-size:12px;line-height:1.45;margin-bottom:16px}.filter-grid{display:grid;grid-template-columns:repeat(4,minmax(150px,1fr));gap:10px;margin-bottom:14px}.filter-grid .field input,.filter-grid .field select{margin-top:5px}.compact-table td,.compact-table th{padding:9px}.details-card summary{display:flex;align-items:center;justify-content:space-between;gap:12px;list-style:none;cursor:pointer}.details-card summary::-webkit-details-marker{display:none}.details-card summary:after{content:'Show';color:var(--primary);font-size:11px;font-weight:700}.details-card[open] summary:after{content:'Hide'}.details-card[open] summary{border-bottom:1px solid var(--silver);padding-bottom:12px}.name-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;grid-column:1/-1}.verification-checklist{display:grid;gap:10px;margin:14px 0}.verification-check{display:grid;grid-template-columns:auto minmax(0,1fr);gap:10px;align-items:start;border:1px solid var(--silver);border-radius:8px;padding:12px}.verification-check input[type="checkbox"]{width:19px;height:19px}.asset-serial-check{display:grid;grid-template-columns:minmax(0,1fr) minmax(180px,.7fr);gap:10px;align-items:end;border:1px solid var(--silver);border-radius:8px;padding:12px}.analytics-results{margin-top:14px}.inline-meta{display:flex;flex-wrap:wrap;gap:8px 16px;color:var(--muted);font-size:12px}.file-box{grid-column:1/-1;border:1px dashed #9aa7ba;border-radius:8px;background:#fafbfc;padding:14px}.file-box .field{margin-top:10px}
.sidebar{transition:width .2s ease,flex-basis .2s ease}.sidebar-heading{justify-content:flex-end;padding:0 18px}.sidebar-toggle{display:grid;place-items:center;width:40px;height:40px;border:1px solid rgba(255,255,255,.35);border-radius:8px;background:transparent;color:#fff}.hamburger{display:grid;gap:4px;width:18px}.hamburger span{display:block;height:2px;border-radius:2px;background:currentColor}.sidebar-nav{padding:14px 0}.nav-link{gap:12px}.nav-icon{width:24px;flex:0 0 24px;text-align:center;font-size:15px;font-weight:800}.nav-text{white-space:nowrap}.sidebar-privacy{margin:14px;padding:12px;border-top:1px solid rgba(255,255,255,.24);color:#cbd5e1;font-size:10px;line-height:1.45}.shell.sidebar-collapsed .sidebar{width:72px;flex-basis:72px}.shell.sidebar-collapsed .sidebar-heading{justify-content:center;padding:0}.shell.sidebar-collapsed .nav-link{justify-content:center;padding:12px 22px}.shell.sidebar-collapsed .nav-text,.shell.sidebar-collapsed .sidebar-privacy{display:none}.request-list{display:grid;gap:8px}.request-row{border:1px solid var(--silver);border-radius:8px;background:#fff;overflow:hidden}.request-row>summary{display:grid;grid-template-columns:minmax(180px,1.2fr) minmax(110px,.55fr) minmax(165px,.85fr) minmax(160px,.9fr) minmax(135px,.65fr) auto;gap:12px;align-items:center;padding:12px;list-style:none}.request-row>summary::-webkit-details-marker{display:none}.request-row>summary:hover{background:#fafafa}.request-row[open]>summary{border-bottom:1px solid var(--silver);background:#fafbff}.request-summary-label{display:none;color:var(--muted);font-size:10px}.request-expand{color:var(--primary);font-size:12px;font-weight:700}.visitor-row-wrap{padding:8px 12px 12px}.visitor-row-table{min-width:820px}.audit-list{display:grid;gap:8px;margin-top:14px}.audit-event{display:grid;grid-template-columns:150px minmax(0,1fr) auto;gap:14px;align-items:start;border-left:3px solid var(--primary);border-radius:0 7px 7px 0;background:#f8f9fc;padding:11px 12px}.audit-event p{margin:0}.audit-category{font-size:11px;font-weight:750;color:var(--primary)}.audit-time{white-space:nowrap;color:var(--muted);font-size:11px}.serial-value{display:block;margin-top:4px;color:var(--ink);font-family:ui-monospace,SFMono-Regular,Consolas,monospace;font-size:13px;font-weight:750}.date-range-control{display:grid;grid-template-columns:minmax(180px,1fr) minmax(180px,1fr);gap:12px;margin-bottom:14px}
...
.sr-only{position:absolute!important;width:1px!important;height:1px!important;padding:0!important;margin:-1px!important;overflow:hidden!important;clip:rect(0,0,0,0)!important;white-space:nowrap!important;border:0!important}.modal-open{overflow:hidden}.breadcrumb{margin:0 0 12px}.breadcrumb ol{display:flex;flex-wrap:wrap;align-items:center;gap:7px;margin:0;padding:0;list-style:none;color:var(--muted);font-size:12px}.breadcrumb li{display:flex;align-items:center;gap:7px}.breadcrumb li:not(:last-child):after{content:'›';color:#9aa3b2}.breadcrumb a{color:var(--primary);font-weight:700}.status-chip{position:relative;display:inline-flex;align-items:center;gap:6px;border:1px solid transparent}.status-chip:before{content:'';width:7px;height:7px;flex:0 0 7px;border-radius:50%;background:currentColor}.status-success{border-color:#b9dec9;background:#e8f6ee;color:#176b45}.status-danger{border-color:#efb9bf;background:#fff0f1;color:#a51f2d}.status-warning{border-color:#ead08a;background:#fff8df;color:#7a5a00}.status-information{border-color:#b9c9e2;background:#eef4fc;color:#224d86}.status-neutral{border-color:#d5d9df;background:#f5f6f8;color:#596273}.tooltip-popup{position:fixed;z-index:200;width:max-content;max-width:min(300px,calc(100vw - 24px));border-radius:6px;background:#151a23;color:#fff;padding:7px 9px;box-shadow:0 6px 20px rgba(0,0,0,.25);font-size:11px;line-height:1.4;pointer-events:none}.filter-summary{display:flex;align-items:center;justify-content:space-between;gap:14px;border:1px solid #ccd5e2;border-radius:9px;background:#f8faff;padding:12px 14px;margin-bottom:16px}.filter-chipset{display:flex;flex-wrap:wrap;align-items:center;gap:7px}.filter-chip{display:inline-flex;align-items:center;gap:7px;min-height:30px;border:1px solid #9daecc;border-radius:999px;background:#fff;color:var(--primary);padding:5px 10px;font-size:11px;font-weight:750}.filter-chip button{font:inherit}.filter-chip span{font-size:16px;line-height:1}.filter-clear{color:var(--primary);font-size:12px;font-weight:700}.analytics-filter-chips{min-height:30px;margin:12px 0}.empty-state{display:grid;justify-items:center;max-width:560px;margin:24px auto;padding:28px;text-align:center}.empty-state-icon{display:grid;place-items:center;width:52px;height:52px;border:2px solid #9aa7ba;border-radius:50%;color:var(--primary);font-size:29px}.empty-state h2{margin:14px 0 6px;color:var(--primary);font-family:Georgia,serif;font-size:20px}.empty-state p{margin:0;color:var(--muted);font-size:13px;line-height:1.5}.error-state{display:grid;grid-template-columns:auto minmax(0,640px);justify-content:center;align-items:center;gap:24px;min-height:52vh;padding:40px 20px}.error-state-code{display:grid;place-items:center;width:72px;height:72px;border-radius:50%;background:#fff0f1;color:var(--danger);font-family:Georgia,serif;font-size:44px;font-weight:800}.error-state h1{margin:0;color:var(--primary)}.error-state p{margin:10px 0 22px;color:var(--muted);line-height:1.55}.skeleton-state{padding:4px 0}.skeleton{border-radius:8px;background:linear-gradient(90deg,#e8ebef 25%,#f6f7f9 50%,#e8ebef 75%);background-size:200% 100%;animation:skeleton-shimmer 1.25s ease-in-out infinite}.skeleton-title{width:min(360px,70%);height:38px;margin-bottom:22px}.skeleton-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px}.skeleton-card{height:92px}.skeleton-panel{height:260px;margin-top:18px}@keyframes skeleton-shimmer{from{background-position:200% 0}to{background-position:-200% 0}}.workflow-progress{border:1px solid var(--silver);border-radius:10px;background:#fff;padding:16px 18px;margin-bottom:16px}.workflow-progress-heading{display:flex;align-items:center;justify-content:space-between;gap:12px}.workflow-progress-heading h2{margin:0;color:var(--primary);font-family:Georgia,serif;font-size:18px}.workflow-progress ol{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));margin:18px 0 0;padding:0;list-style:none}.progress-step{position:relative;display:grid;justify-items:center;gap:7px;color:var(--muted);font-size:11px;font-weight:700;text-align:center}.progress-step:not(:last-child):after{content:'';position:absolute;z-index:0;top:8px;left:calc(50% + 10px);width:calc(100% - 20px);height:2px;background:#d7dce4}.progress-marker{position:relative;z-index:1;width:18px;height:18px;border:2px solid #b7c0cc;border-radius:50%;background:#fff}.progress-complete{color:#176b45}.progress-complete .progress-marker{border-color:#24824f;background:#24824f}.progress-complete .progress-marker:after{content:'✓';position:absolute;inset:-3px;color:#fff;font-size:12px}.progress-complete:not(:last-child):after{background:#24824f}.progress-active{color:var(--primary)}.progress-active .progress-marker{border:5px solid var(--primary)}.progress-error{color:var(--danger)}.progress-error .progress-marker{border-color:var(--danger);background:var(--danger)}.progress-error .progress-marker:after{content:'×';position:absolute;inset:-4px;color:#fff;font-size:14px}.profile-menu{position:relative}.profile-menu summary{list-style:none}.profile-menu summary::-webkit-details-marker{display:none}.profile-summary{display:flex;align-items:center;gap:9px;border:1px solid rgba(255,255,255,.35);border-radius:999px;padding:4px 10px 4px 5px;cursor:pointer}.avatar{display:grid;place-items:center;width:34px;height:34px;flex:0 0 34px;border-radius:50%;background:#fff;color:var(--primary);font-size:11px;font-weight:800}.profile-copy{display:grid;line-height:1.2}.profile-copy strong{font-size:12px}.profile-copy small,.profile-panel-header small{color:#cbd5e1;font-size:10px}.profile-panel{position:absolute;right:0;top:calc(100% + 8px);z-index:90;width:240px;border:1px solid var(--silver);border-radius:9px;background:#fff;color:var(--ink);box-shadow:0 12px 34px rgba(0,0,0,.22);padding:10px}.profile-panel-header{display:flex;align-items:center;gap:10px;border-bottom:1px solid var(--silver);padding:7px 7px 12px}.profile-panel-header span:last-child{display:grid;gap:3px}.profile-panel-header small{color:var(--muted)}.profile-action{width:100%;border:0;border-radius:6px;background:#fff;color:var(--primary);padding:10px;text-align:left;font-weight:700}.profile-action:hover{background:#f4f3ff}.mobile-navigation{display:none;position:relative}.mobile-navigation summary{display:flex;align-items:center;gap:7px;border:1px solid rgba(255,255,255,.35);border-radius:7px;padding:9px;color:#fff;font-size:12px;font-weight:700;list-style:none}.mobile-navigation summary::-webkit-details-marker{display:none}.menu-lines{display:grid;gap:3px;width:15px}.menu-lines span{height:2px;border-radius:2px;background:#fff}.mobile-navigation-panel{position:absolute;top:calc(100% + 8px);left:0;z-index:90;width:min(270px,calc(100vw - 24px));border-radius:9px;background:var(--primary);box-shadow:0 12px 32px rgba(0,0,0,.24);padding:8px}.mobile-navigation-panel .nav-link{border-left:0;border-radius:6px}.footer-top{white-space:nowrap;color:#fff;font-weight:700}.upload-dropzone{display:flex;align-items:center;gap:12px;border:1px dashed #8292aa;border-radius:8px;background:#fff;padding:14px;margin:12px 0;cursor:pointer}.upload-dropzone:hover{border-color:var(--primary);background:#f8f7ff}.upload-dropzone input{max-width:100%;margin-left:auto}.upload-dropzone small{display:block;margin-top:3px;color:var(--muted);font-weight:400}.upload-icon{display:grid;place-items:center;width:36px;height:36px;flex:0 0 36px;border-radius:50%;background:#eceaff;color:var(--primary);font-size:20px;font-weight:800}.upload-progress{height:7px;overflow:hidden;border-radius:999px;background:#e4e8ee;margin:10px 0}.upload-progress span{display:block;width:45%;height:100%;border-radius:inherit;background:var(--primary);animation:upload-progress 1s ease-in-out infinite alternate}@keyframes upload-progress{from{transform:translateX(-20%)}to{transform:translateX(145%)}}
