...
<meta name="theme-color" content="#0067EF">
<link rel="icon" type="image/svg+xml" href="__BRAND_LOGO__">
<title>RR Visitor Management System</title>
<style>
:root{--primary:#0067EF;--primary-dark:#0054C7;--white:#fff;--title:#171717;--ink:#171717;--muted:#525252;--surface:#f5f5f7;--silver:#e5e7eb;--success:#819C00;--danger:#9F0000;--warning:#d99800;font-family:'RR Pioneer',Arial,sans-serif;color:var(--ink);background:var(--surface);font-synthesis:none;text-rendering:optimizeLegibility;-webkit-font-smoothing:antialiased}
*{box-sizing:border-box}body{margin:0;min-width:320px;background:var(--surface)}button,input,select,textarea{font:inherit}button:not(:disabled),a,select,summary{cursor:pointer}button:disabled{cursor:not-allowed}a{color:inherit;text-decoration:none}h1,h2,h3,p{margin-top:0}h1,h2,h3{color:var(--title)}.display{font-family:'RR Pioneer',Arial,sans-serif}.hidden{display:none!important}.app{min-height:100vh}.login-page{min-height:100vh;display:flex;align-items:center;justify-content:center;padding:48px 24px}.login-card{width:100%;max-width:448px;border:1px solid var(--silver);background:#fff;box-shadow:0 4px 18px rgba(20,32,48,.08)}.login-body{padding:32px}.eyebrow{color:var(--primary);font-size:11px;font-weight:700;letter-spacing:.18em;text-transform:none}.login-body h2{color:var(--title);font-size:24px;margin:8px 0 0}.muted{color:var(--muted)}.small{font-size:13px}.tiny{font-size:11px}.primary-button,.secondary-button,.success-button,.danger-button,.warning-button{min-height:40px;border-radius:4px;padding:10px 16px;font-size:14px;font-weight:650;border:1px solid transparent}.primary-button{background:var(--primary);color:#fff}.primary-button:hover{background:var(--primary-dark)}.secondary-button{background:#fff;border-color:var(--primary);color:var(--primary)}.secondary-button:hover{background:#EAF3FF}.success-button{background:var(--success);color:var(--title)}.danger-button{background:var(--danger);color:#fff}.warning-button{background:#ffc107;color:var(--title)}.wide{width:100%}.user-list{display:grid;gap:8px;margin-top:14px}.user-choice{display:flex;width:100%;align-items:center;justify-content:space-between;border:1px solid var(--silver);background:#fff;padding:12px 16px;text-align:left}.user-choice:hover{background:var(--surface)}.user-choice strong,.user-choice span{display:block}.shell{display:flex;min-height:100vh}.sidebar{width:256px;flex:0 0 256px;background:var(--primary);color:#fff;display:flex;flex-direction:column}.sidebar-heading{height:80px;display:flex;align-items:center;padding:0 24px;border-bottom:1px solid var(--primary-dark);font-weight:700;font-size:14px}.sidebar-nav{padding:26px 0;flex:1}.nav-label{padding:10px 20px 7px;color:#fff;font-size:10px;font-weight:700;letter-spacing:.22em;text-transform:none}.nav-link{display:flex;align-items:center;border-left:2px solid transparent;padding:10px 20px;color:#fff;font-size:14px;transition:.15s}.nav-link:hover{background:var(--primary-dark);color:#fff}.nav-link.active{border-left-color:#fff;background:#e9eef6;color:var(--primary);font-weight:650}.workspace{display:flex;min-width:0;flex:1;flex-direction:column}.topbar{height:80px;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid var(--silver);background:#fff;padding:0 32px;position:relative}.search{width:320px;border:1px solid var(--silver);padding:10px 12px;font-size:13px}.top-actions{display:flex;align-items:center;gap:20px}.text-button{border:1px solid transparent;border-radius:4px;background:transparent;color:var(--primary);font-size:14px;font-weight:650;padding:9px 13px}.text-button:hover{background:#EAF3FF}.content{padding:36px 32px 56px;min-width:0}.page{max-width:1440px;margin:0 auto}.page-header{display:flex;align-items:flex-end;justify-content:space-between;gap:16px;margin-bottom:24px}.page-header h1{color:var(--title);font-size:38px;margin:8px 0 0}.page-header p:last-child{margin:8px 0 0}.status-chip{display:inline-block;white-space:nowrap;border-radius:999px;background:#e9eef6;padding:5px 9px;color:var(--primary);font-size:11px;font-weight:700;text-transform:none}.status-live{border-color:var(--success);background:#F3F6E6;color:var(--title)}.status-banner{display:flex;align-items:center;justify-content:space-between;gap:16px;border:1px solid #e6d29a;background:#fff9e8;padding:12px 16px;color:#705b18;font-size:13px;margin-bottom:24px}.summary-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:16px;margin-bottom:24px}.summary-card,.panel,.info-card{border:1px solid var(--silver);background:#fff}.summary-card{padding:16px}.summary-card p{min-height:34px;color:var(--muted);font-size:11px;font-weight:700;line-height:1.25;text-transform:none;margin:0}.summary-card strong{display:block;margin-top:8px;color:var(--primary);font-family:'RR Pioneer',Arial,sans-serif;font-size:32px}.panel,.info-card{padding:20px;margin-bottom:24px;overflow:hidden}.panel-heading{display:flex;align-items:center;justify-content:space-between;gap:16px;border-bottom:1px solid var(--silver);padding-bottom:16px}.panel-heading h2,.info-card h2{color:var(--title);font-family:'RR Pioneer',Arial,sans-serif;font-size:20px;margin:4px 0 0}.split{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:24px}.metric-number{font-size:32px;color:var(--primary);font-weight:700;margin:16px 0 6px}.table-wrap{overflow-x:auto}.data-table{width:100%;border-collapse:collapse;text-align:left;font-size:13px}.data-table th{border-bottom:1px solid var(--silver);padding:13px;color:var(--muted);font-size:10px;text-transform:none;letter-spacing:.05em}.data-table td{border-bottom:1px solid var(--silver);padding:13px;color:var(--muted);vertical-align:top}.data-table td.strong{color:var(--ink);font-weight:650}.data-table tr:last-child td{border-bottom:0}.data-table tbody tr:hover{background:#fafafa}.link{color:var(--primary);font-weight:650}.empty{padding:24px 0;color:var(--muted);font-size:14px}.error-box{display:flex;align-items:center;justify-content:space-between;gap:16px;border:1px solid #e1b5b5;background:#fff4f4;color:var(--danger);padding:16px;font-size:14px;margin-bottom:20px}.form-page{max-width:896px;margin:0 auto}.form-section{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px;border:1px solid var(--silver);background:#fff;padding:24px;margin-bottom:24px}.form-section.single{display:block}.field{display:block;font-size:13px;font-weight:650;color:var(--ink)}.field input,.field select,.field textarea{display:block;width:100%;margin-top:8px;border:1px solid var(--silver);background:#fff;padding:10px 12px;font-weight:400;color:var(--ink);outline:none}.field input:focus,.field select:focus,.field textarea:focus{border-color:var(--primary);box-shadow:0 0 0 2px rgba(0,103,239,.08)}.field-error{display:block;color:var(--danger);font-size:11px;font-weight:400;margin-top:5px}.check-row{display:flex;align-items:center;gap:12px;border:1px solid var(--silver);background:#fff;padding:16px;margin-bottom:12px;font-size:14px;font-weight:650}.date-row,.asset-row{display:grid;grid-template-columns:1fr 1fr 1fr auto;gap:12px;border:1px solid var(--silver);padding:12px;margin-top:12px;align-items:end}.button-row{display:flex;flex-wrap:wrap;gap:12px;align-items:center}.review-box{border:1px solid var(--primary);background:#f4f7fb;padding:20px;margin-bottom:24px}.review-box h2{color:var(--title);font-family:'RR Pioneer',Arial,sans-serif;margin:0}.classification-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:12px;margin:16px 0}.classification{display:flex;align-items:center;gap:12px;border:1px solid var(--silver);background:#fff;padding:12px;font-size:13px;font-weight:650}.swatch{width:12px;height:12px;border-radius:50%}.reception-actions{display:flex;flex-wrap:wrap;align-items:center;gap:12px;border:1px solid var(--primary);background:#e9eef6;padding:20px;margin-bottom:24px}.day-picker{border:1px solid var(--silver);background:#fff;padding:9px 10px}.info-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:24px}.info-card{margin:0}.info-card p{font-size:13px;margin:0 0 9px}.info-card p:last-child{margin-bottom:0}.info-card .record{border-bottom:1px solid var(--silver);padding-bottom:10px;margin-bottom:10px}.info-card .record:last-child{border-bottom:0;margin-bottom:0}.detail-stack{display:grid;gap:24px}.back-link{display:inline-block;margin-bottom:24px}.modal-backdrop{position:fixed;inset:0;z-index:80;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.5);padding:16px}.modal{width:100%;max-width:520px;border:1px solid var(--silver);background:#fff;padding:24px;box-shadow:0 20px 60px rgba(0,0,0,.25)}.modal h2{font-family:'RR Pioneer',Arial,sans-serif;color:var(--title);margin:0}.modal-actions{display:flex;justify-content:flex-end;gap:12px;margin-top:24px}.mobile-menu{display:none}.mobile-records{display:none}.toast{position:fixed;right:24px;bottom:24px;z-index:100;background:var(--title);color:#fff;padding:13px 16px;box-shadow:0 8px 28px rgba(0,0,0,.25);font-size:13px;max-width:360px}.toast.error{background:var(--danger)}.loading{color:var(--muted);font-size:14px}
.required-mark{color:var(--danger);font-weight:800}.required-note{margin:-10px 0 14px;color:var(--muted);font-size:12px;text-align:right}.section-span{grid-column:1/-1;border-bottom:1px solid var(--silver);padding-bottom:14px;margin-bottom:2px}.section-span h2{margin:5px 0 0;color:var(--title);font-size:21px}.schedule-card{border:1px solid var(--silver);background:#fff;padding:24px;margin-bottom:24px}.schedule-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:20px;border-bottom:1px solid var(--silver);padding-bottom:18px}.schedule-heading h2{margin:5px 0 6px;color:var(--title);font-size:24px}.timezone-pill{white-space:nowrap;border-radius:999px;background:#e9eef6;color:var(--primary);padding:7px 11px;font-size:11px;font-weight:700}.schedule-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px;margin-top:20px}.requested-field{border-left:4px solid var(--warning);background:#fff8e1;padding:10px}.phone-fields{display:grid;grid-template-columns:minmax(210px,1fr) minmax(180px,1fr);gap:12px}.phone-input{position:relative}.phone-prefix{position:absolute;left:12px;bottom:11px;color:var(--muted);font-size:13px}.phone-input input{padding-left:58px}.field-note{display:block;margin-top:5px;color:var(--muted);font-size:11px;font-weight:400}.checkbox-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin-top:12px}.checkbox-grid .check-row{margin:0}.summary-link{display:block;position:relative}.summary-link:after{content:'View →';display:block;margin-top:10px;color:var(--primary);font-size:11px;font-weight:700}.summary-link:hover{border-color:var(--primary);box-shadow:0 4px 14px rgba(0,103,239,.08)}.verification-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px;margin:18px 0}.verification-step{border:1px solid #cfd5df;border-radius:8px;background:#fff;padding:16px}.verification-step h3{font-size:14px;margin:0}.verification-step .button-row{margin-top:14px}.badge-panel{display:grid;grid-template-columns:minmax(180px,1fr) minmax(220px,2fr);gap:14px;align-items:end;border:1px solid #cfd5df;border-radius:8px;background:#fff;padding:16px;margin-bottom:14px}.badge-type{display:inline-block;border-radius:999px;padding:7px 11px;color:#fff;font-size:12px;font-weight:750}.badge-orange{background:#a64b00}.badge-red{background:var(--danger)}.completion-checks{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.completion-check{display:flex;align-items:center;gap:10px;border:1px solid var(--primary);border-radius:8px;background:#fff;padding:14px;font-weight:700}.completion-check input{width:19px;height:19px}
:focus-visible{outline:3px solid var(--primary);outline-offset:3px}.skip-link{position:fixed;left:16px;top:-60px;z-index:120;border-radius:6px;background:#fff;color:var(--primary);padding:10px 14px;font-weight:700;box-shadow:0 4px 16px rgba(0,0,0,.2)}.skip-link:focus{top:16px}.primary-button,.secondary-button,.success-button,.danger-button,.warning-button,.text-button,.user-choice,.reception-person{transition:background-color .15s,border-color .15s,box-shadow .15s,transform .15s}.primary-button:active,.secondary-button:active,.success-button:active,.danger-button:active,.warning-button:active,.text-button:active,.user-choice:active,.reception-person:active{transform:translateY(1px)}.summary-card,.panel,.info-card,.form-section,.schedule-card,.review-box,.reception-actions,.login-card{border-radius:10px}.field input,.field select,.field textarea,.search{border-radius:7px;min-height:42px}.compact-button{display:inline-block;min-height:34px;padding:7px 10px}.form-record{display:flex;justify-content:space-between;align-items:center;gap:12px}.selection-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;margin:18px 0}.selection-card{display:grid;grid-template-columns:auto minmax(0,1fr) auto auto;align-items:center;gap:10px;border:1px solid #cfd5df;border-radius:8px;background:#fff;padding:12px;cursor:pointer}.selection-card:has(input:checked){border-color:var(--primary);box-shadow:0 0 0 2px rgba(0,103,239,.1)}.selection-card small{display:block;color:var(--muted);margin-top:3px}.tag{display:inline-block;border-radius:999px;padding:5px 9px;color:#fff;font-size:11px;font-weight:750}.tag-vendor{background:#a64b00}.tag-visitor{background:var(--danger)}.reception-actions{display:block}.reception-queue{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;margin-bottom:18px}.reception-person{display:flex;align-items:center;justify-content:space-between;gap:12px;border:1px solid #cfd5df;border-radius:8px;background:#fff;padding:12px;text-align:left}.reception-person small{display:block;color:var(--muted);margin-top:4px}.reception-person.active{border-color:var(--primary);box-shadow:0 0 0 2px rgba(0,103,239,.12);background:#EEF6FF}.reception-controls{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;margin-bottom:14px}.modal{max-height:min(720px,calc(100vh - 32px));overflow-y:auto;border-radius:12px}.toast{border-radius:8px}.mobile-reception{display:none}
